...
function AddExpensesModal({ show, onClose }) {
  ...
  const addExpenseItemHandler = async () => {
    ...
    try {
      ...
      onClose();
      toast.success("Nouvelle dépense enregistré avec succès!");
    } catch (error) {
      ...
      {expenseAmount > 0 && (
        <div className="flex flex-col gap-4 mt-6">
          <div className="flex items-center justify-between">
            <h3 className="text-2xl capitalize">Selectionnez une categorie de dépense</h3>
            <button
              onClick={() => {
          ...
          {showAddExpense && (
            <div className="flex items-center justify-between">
              <input type="text" placeholder="Entrez un titre" ref={titleRef} />
